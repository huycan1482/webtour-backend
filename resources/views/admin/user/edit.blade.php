            ...
            <div class="box box-primary">
                ...
                <form role="form" action="{{ route('admin.user.update', ['id' => $user->id ]) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="box-body">
                        ...
                        @endif
                            <label>Email</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Nhập mail" value="{{ $user->email }}">
                        ...
                        @endif
                            ...
                            <input type="text" class="form-control" id="password" name="password" placeholder="Nhập mật khẩu" value="">
